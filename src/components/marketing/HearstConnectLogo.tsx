/** Inline Hearst Connect wordmark. Fills are hardcoded (#fff + #a7fb90) so
 * the mark always renders — bypasses the <defs><style> pattern in the SVG
 * asset that some renderers handle unreliably. */
export function HearstConnectLogo({ className, style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg
      className={className}
      style={style}
